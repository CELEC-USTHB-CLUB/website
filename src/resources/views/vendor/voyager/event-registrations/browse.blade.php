        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    @if(request()->has('key') AND request()->query('key') === 'training_id' AND request()->has('filter') AND request()->query('filter') === 'equals')
                        <form method="POST" action={{url('admin/trainings/exportRegistrations/'.request()->query('s'))}}>
                            @csrf
                            <div style="margin: 2%;">
                                <div>
                                    <p>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            <td>
                                                ...
                                                @elseif($row->type == 'text')
                                                	...
                                                	@else
                                                		@foreach($data->{$row->field} as $dataRowField)
                                                			<div>{{ mb_strlen( $dataRowField ) > 200 ? mb_substr($dataRowField, 0, 200) . ' ...' : $dataRowField }}</div>
                                                		@endforeach
                                                	@endif
